// NOTE: all the code below is taken from https://github.com/SRombauts/SimplexNoise
// and adapted to compile under Unity 2017.3.1f1

#if !defined(SIMPLEXNOISE_INCLUDED)
 ...
 *
 * Note that making this an uint[] instead of a uint[] might make the
